...
UPDATE dbo.customer
SET first_name = 'Aidan', last_name = 'Polivka'
WHERE customer_id = '1d399f7b-5a54-4f6a-b54c-2c284cbcab00';

-- Update product ppu
UPDATE dbo.product
SET price_per_unit = 12.65
WHERE product_id = '036b14ae-d6c0-469a-861a-b8224c6f33b2';

-- Update order status (cancelled)
UPDATE dbo.[order]
SET order_status_id = 5
WHERE order_id = '53d8da18-9458-432d-b83c-2f8124a2bbe6';

-- Add image url to event
UPDATE dbo.event
SET image_url = 'some_other_image_url'
WHERE event_id = '34de8545-ecdf-4ec8-92ad-c388eed10303';

-- Change default address
DECLARE @customer_id VARCHAR(36);
DECLARE @default_address_id VARCHAR(36);
SET @customer_id = '1d399f7b-5a54-4f6a-b54c-2c284cbcab00';
SET @default_address_id= 'bd691b02-111d-4aab-8fa4-da70f500c9f2';
...
BEGIN TRANSACTION
	...
	IF (@@ERROR <> 0) BEGIN
		PRINT 'Failed to update default address'
		ROLLBACK TRANSACTION
	END
COMMIT
